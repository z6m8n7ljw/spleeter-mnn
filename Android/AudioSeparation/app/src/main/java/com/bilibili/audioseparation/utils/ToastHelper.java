...
public class ToastHelper {
    ...
    public static void show(int stringId) {
        Toast.makeText(BaseApplication.getContext(), BaseApplication.getContext().getResources().getText(stringId),
    ...
    public static void showOnUiThread(final String msg) {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            sHandler.post(() -> Toast.makeText(BaseApplication.getContext(), msg, Toast.LENGTH_SHORT).show());
        } else {
            show(msg);
        }
    }
    ...
    public static void showOnUiThread(final int stringId) {
        if (Looper.myLooper() != Looper.getMainLooper()) {
            sHandler.post(
                    () -> Toast
                            .makeText(BaseApplication.getContext(),
                                    BaseApplication.getContext().getResources().getText(stringId), Toast.LENGTH_SHORT)
                            .show());
        } else {
            show(stringId);
        }
    ...
    public static void showOnUiThread(final Activity activity, final int stringId) {
        activity.runOnUiThread(
                () -> Toast.makeText(activity, activity.getResources().getText(stringId), Toast.LENGTH_SHORT).show());
    }
